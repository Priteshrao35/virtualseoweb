  ...
  return (
    <div className="bg-blue-50 p-10">
      ...
      <div className="md:pl-72">
        ...
        >
          <SwiperSlide className="border border-black hover:border-red-600 hover:bg-gray-100 transition duration-300 flex flex-col items-center p-4 rounded-xl">
            <Image
              className="w-full"
              src="/homepage/p2.jpg"
              alt="Design"
            ...
            <div className="text-left pl-5">
              ...
              <p className="text-black hover:bg-gray-200 hover:text-red-500 hover:pl-2 transition duration-300 mb-2">
                ...
                sit, temporibus omnis voluptatibus rerum mollitia sed magni
                accusamus impedit ullam!
              </p>
