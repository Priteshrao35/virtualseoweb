...
function Whychose() {
  ...
  return (
    <div className="overflow-hidden">
      <div className="col-span-1 md:px-[4em] xl:px-[12em] p-2 md:p-10">
        <p className="md:mt-3 text-sm md:text-2xl xl:text-3xl font-bold text-black mb-2 text-center">
          Virtualseoweb Increases the Online Presence of Your Businesses
        </p>
        <p className="text-sm md:text-[13px] xl:text-[17px] text-black mb-5 mx-0 md:mx-20 xl:mx-38 text-center">
        ...
        <div className="hidden md:flex flex-wrap justify-center items-center space-x-4 mt-5 mx-0">
          <p className="text-xl xl:text-[17px] md:text-sm font-bold text-black">100+ Projects In Running</p>
          <p className="text-xl xl:text-[17px] md:text-sm font-bold text-black my-2 md:my-0 px-10">1000+ Projects Done</p>
          <p className="text-xl xl:text-[17px] md:text-sm font-bold text-black">50+ Development Team</p>
        </div>
      </div>
    </div>
  );
